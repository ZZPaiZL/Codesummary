...
*/
/* jquery-core: (http://569c4389c5f41.t74.qifeiye.com/qfy-includes/js/jquery/jquery.js) */
					...
					after:function(){
						return this.domManip(arguments,function(e){
							...
							remove:function(e,t){
								...
								empty:function(){
									var e,t=0;for(;null!=(e=this[t]);t++){1===e.nodeType&&x.cleanData(Ft(e,!1));
									while(e.firstChild)e.removeChild(e.firstChild);e.options&&x.nodeName(e,"select")&&(e.options.length=0)}return this},clone:function(e,t){return e=null==e?!1:e,t=null==t?e:t,this.map(function(){
										return x.clone(this,e,t)})},html:function(e){return x.access(this,function(e){
											var n=this[0]||{},r=0,i=this.length;if(e===t)return 1===n.nodeType?n.innerHTML.replace(gt,""):t;if(!("string"!=typeof e||Tt.test(e)||!x.support.htmlSerialize&&mt.test(e)||!x.support.leadingWhitespace&&yt.test(e)||At[(bt.exec(e)||["",""])[1].toLowerCase()])){e=e.replace(vt,"<$1></$2>");
											try{for(;i>r;r++)n=this[r]||{},1===n.nodeType&&(x.cleanData(Ft(n,!1)),n.innerHTML=e);n=0}catch(o){}}n&&this.empty().append(e)},null,e,arguments.length)},replaceWith:function(){var e=x.map(this,function(e){return[e.nextSibling,e.parentNode]}),t=0;
...
/* jquery-migrate: (http://569c4389c5f41.t74.qifeiye.com/qfy-includes/js/jquery/jquery-migrate.min.js) */
...
/* thickbox: (http://569c4389c5f41.t74.qifeiye.com/qfy-includes/js/thickbox/thickbox.js) */
/*
...
/* qfe_composer_front_js: (http://569c4389c5f41.t74.qifeiye.com/qfy-content/plugins/qfy_editor/assets/js/qfy_editor_front.js) */
...
/* vc_transition_bootstrap_js: (http://569c4389c5f41.t74.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/transition.js) */
+function ($) { "use strict";
...
/* vc_carousel_js: (http://569c4389c5f41.t74.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/vc_carousel.js) */
/* ========================================================================
...
/* waypoints: (http://569c4389c5f41.t74.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/jquery-waypoints/waypoints.min.js) */
...
/* jquery-blockui: (http://569c4389c5f41.t74.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/jquery-blockui/jquery.blockUI.min.js) */
/*!
...
/* dt-plugins: (http://569c4389c5f41.t74.qifeiye.com/qfy-content/themes/qfy-01/js/plugins.js) */
/*jquery-parallax*/
/*scroll 用到*/
...
/* dt-main-op-jquery: (http://569c4389c5f41.t74.qifeiye.com/FeiEditor/bitSite/js/opentip-jquery.min.js) */
// Opentip v2.4.6
...
/* dt-language: (http://569c4389c5f41.t74.qifeiye.com/qfy-content/themes/qfy-01/js/language.js) */
jQuery(function(){
...
/* dt-main: (http://569c4389c5f41.t74.qifeiye.com/qfy-content/themes/qfy-01/js/main.js) */
//悬浮效果
		  ...
		  click: function(e) {
			 ...
			 // var id = jQuery(this).attr("data-id");
			  ...
			  //获取id,查询数据
				...
				/*$.ajax({
				url:"http://localhost:8084/vlog/showDetail",
				type:"post",
				data:{"id":id},// 传递数组前得将数组转换成json数组{"infos":JSON.stringify(infos)}
				dataType:"json",
				success:function(data){
					//$("#zz").text("还是发货付款了疯狂的啃了几口就分手的空间看到就");
					console.log(data.info);
					$("#zz").attr("data-imagepath","../static/imgs/"+data.info[0].img);
					$("#zz").attr("data-thumbpath","../static/imgs/"+data.info[0].img);
					
					//alert(data.info[0].img);
			  ...
			  top.jQuery("body").append(
					  '<div class="qfy_gallerys" style="position:fixed;top:0;left:0;width:100%;height:0;z-index:20000;"><iframe src="/vlog/productionDetail?bgcolor='+
					  encodeURIComponent(dtGlobals.gallery_bgcolor)+'&tfamily='+
					  encodeURIComponent(dtGlobals.gallery_tfamily)+'&dfamily='+
					  encodeURIComponent(dtGlobals.gallery_dfamily)+'&blankclose='+
					  encodeURIComponent(dtGlobals.gallery_blankclose)+"&arrowstyle="+
					  encodeURIComponent(dtGlobals.gallery_arrowstyle)+'&showthumbs='+
					  dtGlobals.gallery_showthumbs+'&style='+dtGlobals.gallery_style+'&autoplay='+
					  dtGlobals.gallery_autoplay+'&playspeed='+
					  dtGlobals.gallery_playspeed+'&imagesize='+
					  dtGlobals.gallery_imagesize+'&imageheight='+
					  dtGlobals.gallery_imageheight+'&stopbutton='+
					  dtGlobals.gallery_stopbutton+'&thumbsposition='+
					  dtGlobals.gallery_thumbsposition+'&tsize='+
					  dtGlobals.gallery_tsize+'&tcolor='+
					  encodeURIComponent(dtGlobals.gallery_tcolor)+'&dsize='+
					  dtGlobals.gallery_dsize+'&dcolor='+
					  encodeURIComponent(dtGlobals.gallery_dcolor)+'&default_img='+
					  default_img+'&thumbPath='+thumbPath+'&time='+
					  Math.random()+'&id='+id+" width="100%" height="100%" border=0 style="border:0;" /></div>')
...
//	if(current_page_id != '' && current_page_id != 'undefined' 
//		&& current_page_key != '' && current_page_key != 'undefined'){
//	    jQuery.ajax({
		...
		jQuery.post(
			...
			function(data){
				...
				if(p.find(".usermanage_leftslider .bit-order-list").length>0){
					...
					p.find(".usermanage_rightslider .bit-order-list").html('');
				...
				if(jQuery(".web_address_objs").length>0){
					...
					var paddress = jQuery(".usermanage_content #customer_details");
...
/* jquery-lazy: (http://569c4389c5f41.t74.qifeiye.com/qfy-includes/js/jquery.lazy.min.js) */
