package com.miniprogram.pojo.vo;
...
public class MiniUsersVo {
     ...
     * 用户名
     */
    @ApiModelProperty(value="用户名",name="username",example="zzp",required=true)
	...
	public boolean isIslikeVideo() {
		return islikeVideo;
	}

	public void setIslikeVideo(boolean islikeVideo) {
